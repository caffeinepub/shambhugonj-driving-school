...
export default function Footer() {
  ...
  return (
    <footer
      style={{
        background: "oklch(0.16 0.060 240)",
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            >
              গণপ্রজাতন্ত্রী বাংলাদেশ সরকার অনুমোদিত ড্রাইভিং প্রশিক্ষণ কেন্দ্র। নিরাপদ সড়কের
              জন্য চাই দক্ষ চালক।
            </p>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <a
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110"
                style={{
                  background: "oklch(0.26 0.065 240)",
            ...
            <ul className="space-y-3.5">
              ...
              >
                ...
                <div>
                  <div>
                    অফিস:{" "}
                    <a href="tel:01711605754" className="hover:underline">
                      01711605754
                    </a>
                  </div>
                </div>
              ...
              >
                ...
                />
                <a
                  href="mailto:shambhugonjdrivingschool@gmail.com"
