...
export default function AdmissionForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="admission-name" style={labelStyle}>
          নাম *
        </label>
        <input
          id="admission-name"
      ...
      <div>
        <label htmlFor="admission-phone" style={labelStyle}>
          ফোন নম্বর *
        </label>
        <input
          id="admission-phone"
      ...
      <div>
        <label htmlFor="admission-address" style={labelStyle}>
          ঠিকানা *
        </label>
        <input
      ...
      <div>
        <label htmlFor="admission-course" style={labelStyle}>
          কোর্স নির্বাচন করুন *
        </label>
        <select
          id="admission-course"
      ...
      <div>
        <label htmlFor="admission-message" style={labelStyle}>
          বার্তা (ঐচ্ছিক)
        </label>
        <textarea
