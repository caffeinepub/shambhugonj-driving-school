...
export default function Header() {
  ...
  return (
    <header
      ...
      style={{ boxShadow: "0 4px 20px oklch(0.14 0.055 240 / 0.35)" }}
    >
      {/* ── TOP BAR ── */}
      <div
        style={{
          background: "oklch(0.14 0.055 240)",
          borderBottom: "1px solid oklch(0.22 0.060 240)",
        }}
      >
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <Link to="/" className="flex items-center gap-3 group shrink-0">
            <div
              ...
              style={{
                ...
                background: "oklch(0.24 0.070 240)",
              }}
            >
              <img
          ...
          <div className="hidden sm:flex flex-col items-end gap-1 shrink-0">
            ...
            <div
              ...
              style={{ color: "oklch(0.75 0.020 85)" }}
            >
              <span className="flex items-center gap-1">
                <Phone size={11} />
                অফিস:{" "}
                <a href="tel:01711605754" className="hover:underline ml-0.5">
                  01711605754
                </a>
              </span>
              <span className="flex items-center gap-1">
      ...
      <div
        style={{
          ...
          borderTop: "1px solid oklch(0.28 0.060 240)",
        }}
      >
