            ...
            {plans.map((plan) => (
              <div
                ...
                style={{
                  ...
                  border: plan.popular ? '2px solid var(--shim-gold)' : '1.5px solid var(--olive-pale)',
                }}
              >
                {plan.popular && (
                  <div
                ...
                <div className="text-center mb-4">
                  <h3
                    ...
                    style={{ color: plan.popular ? 'oklch(0.97 0.010 95)' : 'var(--olive-dark)' }}
                  >
                    {plan.titleBn}
                  </h3>
                  <p
                    className="text-xs mb-3"
                    style={{ color: plan.popular ? 'oklch(0.85 0.025 100)' : 'var(--muted-foreground)' }}
                  >
                    {plan.subtitle}
                  </p>
                  {/* Price badge */}
                  <div className="flex justify-center">
                    <div
                      ...
                      style={{
                        ...
                        background: plan.popular ? 'oklch(0.38 0.075 120)' : 'var(--stone-warm)',
                      }}
                    >
                      <span
                        className="text-lg font-extrabold"
                        style={{ color: plan.popular ? 'var(--shim-gold)' : 'var(--olive-dark)' }}
                      >
                        {plan.price}
                      </span>
                    </div>
                ...
                <ul className="space-y-2 mb-6 flex-1">
                  {plan.features.map((f, i) => (
                    <li key={i} className="flex items-center gap-2 text-xs">
                      <CheckCircle
                        size={13}
                        style={{ color: plan.popular ? 'var(--shim-gold)' : 'var(--olive-mid)', flexShrink: 0 }}
                      />
                      <span style={{ color: plan.popular ? 'oklch(0.90 0.020 100)' : 'var(--foreground)' }}>
                        {f}
                      </span>
                    </li>
                  ))}
                ...
                <Link
                  ...
                  style={{
                    background: plan.popular ? 'var(--shim-gold)' : 'var(--olive-mid)',
                    color: plan.popular ? 'oklch(0.22 0.025 95)' : 'var(--stone-warm)',
                  }}
                >
                  ভর্তি হন
                </Link>
