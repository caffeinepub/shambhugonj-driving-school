...
import {
  Phone, CheckCircle, Clock, Award, Users, Star,
  BedDouble, UtensilsCrossed, ChevronRight, Shield, BookOpen, Bike
} from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(135deg, oklch(0.14 0.055 240 / 0.92) 0%, oklch(0.18 0.065 240 / 0.80) 60%, oklch(0.22 0.068 240 / 0.70) 100%)' }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 w-full">
          <div className="max-w-2xl">
            ...
            <h1
              ...
              style={{ color: 'oklch(0.97 0.008 85)', textShadow: '0 2px 16px oklch(0.14 0.055 240 / 0.8)' }}
            >
            ...
            <div
              ...
              style={{ background: 'linear-gradient(90deg, oklch(0.78 0.12 75), oklch(0.86 0.10 75))' }}
            />

            {/* Subheading */}
            <p
              className="text-xl sm:text-2xl font-bold mb-8"
              style={{ color: 'oklch(0.78 0.12 75)', textShadow: '0 1px 8px oklch(0.14 0.055 240 / 0.6)' }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div
                ...
                style={{ background: 'oklch(0.18 0.065 240)', color: 'oklch(0.78 0.12 75)' }}
              >
                আমাদের সম্পর্কে
              </div>
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-4" style={{ color: 'oklch(0.18 0.065 240)' }}>
              ...
              <div
                ...
                style={{ background: 'linear-gradient(90deg, oklch(0.78 0.12 75), oklch(0.86 0.10 75))' }}
              />
              <p className="text-base leading-relaxed mb-4" style={{ color: 'oklch(0.28 0.045 240)' }}>
                শম্ভুগঞ্জ ড্রাইভিং স্কুল একটি সরকার অনুমোদিত ও নিবন্ধিত ড্রাইভিং প্রশিক্ষণ কেন্দ্র। আমরা সরকার নির্ধারিত ৬০ ঘণ্টার বাধ্যতামূলক প্রশিক্ষণ নিয়ম অনুসরণ করে থিওরি ও প্র্যাকটিক্যাল প্রশিক্ষণ প্রদান করি। আমাদের লক্ষ্য দক্ষ, সচেতন ও দায়িত্বশীল ড্রাইভার তৈরি করা।
              </p>
              <div
            ...
            <div className="flex justify-center">
              <div
                ...
                style={{ border: '3px solid oklch(0.78 0.12 75)', boxShadow: '0 8px 32px oklch(0.18 0.065 240 / 0.20)' }}
              >
                <img
      ...
      <section className="py-16" style={{ background: 'oklch(0.93 0.018 85)' }}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-3" style={{ color: 'oklch(0.18 0.065 240)' }}>
            ...
            <div
              ...
              style={{ background: 'linear-gradient(90deg, oklch(0.78 0.12 75), oklch(0.86 0.10 75))' }}
            />
            <p className="text-sm max-w-xl mx-auto" style={{ color: 'oklch(0.40 0.040 240)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {courses.map((course) => (
              <div
                ...
                style={{
                  background: course.popular ? 'oklch(0.18 0.065 240)' : 'oklch(0.98 0.008 85)',
              ...
              >
                ...
                <div className={`p-6 flex flex-col flex-1 ${course.badge ? 'pt-10' : ''}`}>
                  {/* Icon */}
                  <div
                    className="w-14 h-14 rounded-xl flex items-center justify-center mb-4"
                    style={{
                      background: course.popular ? 'oklch(0.78 0.12 75 / 0.20)' : 'oklch(0.18 0.065 240 / 0.08)',
                      color: course.popular ? 'oklch(0.78 0.12 75)' : 'oklch(0.18 0.065 240)',
                    }}
                  >
                    {course.icon}
                  </div>
                  ...
                  <h3
                    ...
                    style={{ color: course.popular ? 'oklch(0.96 0.012 85)' : 'oklch(0.18 0.065 240)' }}
                  >
                    {course.titleBn}
                  </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {course.details.map((d, i) => (
                        <span
                          ...
                          style={{
                            background: course.popular ? 'oklch(0.78 0.12 75 / 0.15)' : 'oklch(0.18 0.065 240 / 0.08)',
                            color: course.popular ? 'oklch(0.86 0.10 75)' : 'oklch(0.24 0.070 240)',
                          }}
                        >
                          {d.label}: {d.value}
                        </span>
                  ...
                  <ul className="space-y-1.5 mb-5 flex-1">
                    {course.features.map((f, i) => (
                      <li
                        ...
                        style={{ color: course.popular ? 'oklch(0.82 0.018 85)' : 'oklch(0.35 0.040 240)' }}
                      >
                        <CheckCircle
                          size={14}
                          style={{ color: course.popular ? 'oklch(0.78 0.12 75)' : 'oklch(0.42 0.055 240)', flexShrink: 0 }}
                        />
                        {f}
                      </li>
                    ))}
                  ...
                  {course.fee && (
                    <div
                      ...
                      style={{ color: course.popular ? 'oklch(0.78 0.12 75)' : 'oklch(0.18 0.065 240)' }}
                    >
                      {course.fee}
                    </div>
                  )}
                  ...
                  <a
                    ...
                    style={{
                      background: course.popular ? 'oklch(0.78 0.12 75)' : 'oklch(0.18 0.065 240)',
                      color: course.popular ? 'oklch(0.18 0.065 240)' : 'oklch(0.96 0.012 85)',
                    }}
                  >
                    ভর্তি হতে কল করুন
                  </a>
      ...
      ════════════════════════════════════════ */}
      <section className="py-16" style={{ background: 'oklch(0.18 0.065 240)' }}>
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <div
              className="inline-block text-xs font-semibold px-3 py-1 rounded-full mb-4"
              style={{ background: 'oklch(0.78 0.12 75 / 0.20)', color: 'oklch(0.78 0.12 75)' }}
            >
              বিশেষ সুবিধা
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-3" style={{ color: 'oklch(0.96 0.012 85)' }}>
              ...
              >
                ...
                <div className="p-5">
                  <div
                    ...
                    style={{ background: 'oklch(0.78 0.12 75 / 0.15)', color: 'oklch(0.78 0.12 75)' }}
                  >
                    {facility.icon}
                  </div>
                  <h3 className="font-bold text-base mb-2" style={{ color: 'oklch(0.96 0.012 85)' }}>
                    {facility.title}
                  </h3>
                  <p className="text-sm" style={{ color: 'oklch(0.75 0.020 240)' }}>
                    {facility.desc}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5">
            {teamMembers.map((member) => (
              ...
              >
                ...
                <h3 className="font-bold text-sm mb-1 leading-snug" style={{ color: 'oklch(0.18 0.065 240)' }}>
                  {member.name}
                </h3>
                <p className="text-xs font-medium" style={{ color: 'oklch(0.42 0.055 240)' }}>
                  {member.position}
                </p>
              </div>
            ))}
      ...
      <section className="py-16" style={{ background: 'oklch(0.18 0.065 240)' }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-4" style={{ color: 'oklch(0.96 0.012 85)' }}>
            আজই ভর্তি হোন
          </h2>
          <div
            ...
            style={{ background: 'linear-gradient(90deg, oklch(0.78 0.12 75), oklch(0.86 0.10 75))' }}
          />
          <p className="text-sm mb-8" style={{ color: 'oklch(0.75 0.020 240)' }}>
