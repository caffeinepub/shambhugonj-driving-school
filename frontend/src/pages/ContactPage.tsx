...
import { Phone, Mail, MapPin, Send, Loader2, Clock, Shield } from 'lucide-react';
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await actor.submitContactForm(form.name, form.email, form.phone, form.message);
      setSubmitted(true);
    ...
    <main>
      ...
      <section className="py-16" style={{ background: 'oklch(0.18 0.065 240)' }}>
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-3" style={{ color: 'oklch(0.96 0.012 85)' }}>
            যোগাযোগ
          </h1>
          <div
          ...
          />
          <p className="text-sm max-w-xl mx-auto" style={{ color: 'oklch(0.72 0.020 85)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl font-extrabold mb-2" style={{ color: 'oklch(0.96 0.012 85)' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div
                ...
                style={{ background: 'oklch(0.22 0.068 240)', border: '1px solid oklch(0.30 0.060 240)' }}
              >
                <div
                ...
                <div>
                  <div className="text-xs font-semibold mb-1" style={{ color: 'oklch(0.72 0.020 85)' }}>
                    প্রধান মোবাইল
                  </div>
                  <a
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-base font-bold" style={{ color: 'oklch(0.96 0.012 85)' }}>
                    সকাল ৯টা – রাত ৯টা
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm font-medium leading-relaxed" style={{ color: 'oklch(0.88 0.018 85)' }}>
                    ৩৩ নং ওয়ার্ড, ময়মনসিংহ সিটি কর্পোরেশন, নেত্রকোনা রোড, শম্ভুগঞ্জ সদর, ময়মনসিংহ
                  </div>
                </div>
              </div>
            </div>
          ...
          <div
            ...
            style={{ border: '2px solid oklch(0.82 0.020 85)', boxShadow: '0 4px 20px oklch(0.18 0.065 240 / 0.12)' }}
          >
            <iframe
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              <h2 className="text-xl font-extrabold mb-6 text-center" style={{ color: 'oklch(0.18 0.065 240)' }}>
                বার্তা পাঠান
              </h2>
              ...
              {submitted ? (
                <div
                  ...
                  style={{ background: 'oklch(0.93 0.018 85)', border: '1.5px solid oklch(0.82 0.020 85)' }}
                >
                  <div className="text-4xl mb-3">✅</div>
                  <p className="font-bold text-base mb-1" style={{ color: 'oklch(0.18 0.065 240)' }}>
                    বার্তা পাঠানো হয়েছে!
                  </p>
                  <p className="text-sm" style={{ color: 'oklch(0.40 0.040 240)' }}>
                    আমরা শীঘ্রই আপনার সাথে যোগাযোগ করব।
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    className="mt-4 px-5 py-2 rounded-lg text-sm font-semibold"
                    style={{ background: 'oklch(0.18 0.065 240)', color: 'oklch(0.96 0.012 85)' }}
                  >
                    আরেকটি বার্তা পাঠান
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold mb-1.5" style={{ color: 'oklch(0.24 0.070 240)' }}>
                        নাম *
                      </label>
                      <input
                        type="text"
                  ...
                  {error && (
                    <p className="text-xs" style={{ color: 'oklch(0.55 0.20 25)' }}>{error}</p>
                  )}
                  <button
                    type="submit"
                    disabled={submitting}
