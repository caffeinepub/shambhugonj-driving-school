...
import { Clock, CheckCircle, Star, Shield, Award, BookOpen, Bike, Phone, ChevronRight } from 'lucide-react';
...
export default function CoursesPage() {
  return (
    <main>
      ...
      {/* ── CTA ── */}
      <section className="py-14" style={{ background: 'oklch(0.18 0.065 240)' }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-extrabold mb-3" style={{ color: 'oklch(0.96 0.012 85)' }}>
            আজই শুরু করুন
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              to="/admission"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-lg font-bold text-sm transition-all hover:-translate-y-0.5"
              style={{ background: 'oklch(0.96 0.012 85)', color: 'oklch(0.18 0.065 240)' }}
            >
