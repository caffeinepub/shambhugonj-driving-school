...
export function filterStudentsByDate(students: StudentRecord[], date: string): StudentRecord[] {
  return students.filter(s => s.admissionDate === date);
}

export function filterStudentsByMonth(students: StudentRecord[], yearMonth: string): StudentRecord[] {
